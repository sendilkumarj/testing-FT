...
Description: The objective of the trigger is to update the parent last modified date of an object based on chatter comments.
             Any comment is inserted to decision or plan object the last modified date of that parent object is updated.
***************************************************
*/

trigger FeedCommentBeforeAfterInsert on FeedComment (after insert, before insert) {
	if(trigger.isAfter){
